...
- **Collections** — organize bookmarks into collections. CRUD, paginated listing, and a default **General** collection created at registration.
...
| [docs/collections](docs/collections/README.md) | Collection CRUD, pagination, logging |
...
├── collections/   # collection CRUD with pagination
├── common/        # shared: pagination, response envelope, exception filter, decorators
